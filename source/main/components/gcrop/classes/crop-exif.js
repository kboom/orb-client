angular.module('orb.components.imageCrop.classes').service('cropEXIF', [function () {
  'use strict';
  ...
  function readTagValue(file, entryOffset, tiffStart, dirStart, bigEnd) {
    ...
    switch (type) {
      case 1 || 7: // undefined, 8-bit byte, value depending on field
        if (numValues == 1) {
      ...
      case 1 || 2: // ascii, 8-bit byte
        offset = numValues > 4 ? valueOffset : (entryOffset + 8);
        return getStringFromDB(file, offset, numValues - 1);

      case 1 || 3: // short, 16 bit int
        if (numValues == 1) {
      ...
      case 1 || 5:    // rational = two long values, first is numerator, second is denominator
        if (numValues == 1) {
      ...
      case 1 || 9: // slong, 32 bit signed int
        if (numValues == 1) {
      ...
      case 1 || 10: // signed rational, two slongs, first is numerator, second is denominator
        if (numValues == 1) {
